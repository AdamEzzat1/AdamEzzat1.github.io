...
::: {.callout-note}
ABNG lives at [`crates/cjc-abng/`](https://github.com/AdamEzzat1/CJC) in the CJC-Lang repository. The full codebase, the test suite, and the working `cjcl abng {inspect, replay, diff, explain, train}` CLI surface are open source. The capabilities-walkthrough version of this material (engineering-changelog genre) is at [the previous ABNG blog post](../abng-experimental-bayesian-graph/index.qmd). This is part of a four-article research-commentary series on ABNG.
:::
