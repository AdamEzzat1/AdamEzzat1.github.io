...
The new numbers beat the first post on every probabilistic axis *without* Platt calibration. The +0.054 AUC lift is the main story; it puts ABNG in the strong-published-model band on its linear-only configuration. The first post said:
